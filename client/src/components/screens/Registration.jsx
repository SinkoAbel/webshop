        ...
        <div id="form" className="block bg-slate-50 p-6 rounded-xl shadow-lg shadow-slate-300 w-[420px] mt-[-90px] text-left py-2">
            <form action="">
                ...
                <input type="submit" name="register" value="Regisztrálok" id="signUp"
                    className="bg-blue-700 w-full h-10 cursor-pointer text-white rounded-md hover:bg-blue-600 hover:outline outline-2 outline-blue-600 outline-offset-2 text-sm mt-5"/><br/>
